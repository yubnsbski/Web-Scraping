...
function ScrapeTab({
  ...
  const [missingRegistryPath, setMissingRegistryPath] = useState(
    "local_docs/edinet/source_registry_missing_edinet.yaml",
  );
  const [missingMaxTargets, setMissingMaxTargets] = useState(200);
